...
import { TestOptions, TestImage } from '../TestOptions';
...
export const FileUpload: React.FC<FileUploadProps> = ({ onFileSelect, onTestImageSelect, disabled = false }) => {
  ...
  return (
    <div>
      ...
      {/* Test Options */}
      <TestOptions
        onTestImageSelect={onTestImageSelect}
        disabled={disabled}
      />
    </div>
  );
