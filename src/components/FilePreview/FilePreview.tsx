  ...
  return (
    <div className="h-full flex flex-col bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="flex-shrink-0 bg-gray-50 px-6 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-600">Confirm this is the receipt you want to process</p>
      </div>

      {/* Main Content Area - Flexible */}
      <div className="flex-1 flex overflow-hidden">
        
        {/* Image Preview - Left Side - Scrollable */}
        ...
        {/* File Information - Right Side - Fixed Width */}
        <div className="w-80 flex-shrink-0 bg-gray-50 border-l border-gray-200 p-4 flex flex-col">
          <h4 className="text-sm font-semibold text-gray-800 mb-3">File Details</h4>
