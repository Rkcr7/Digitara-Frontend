...
export const FilePreview: React.FC<FilePreviewProps> = ({ file, onCancel, onConfirm }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-white rounded-lg shadow-md overflow-hidden">
      {/* Compact Header */}
      <div className="flex-shrink-0 bg-gray-50 px-4 py-3 sm:px-6 border-b border-gray-200">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="flex-1 p-4 overflow-auto min-h-80 md:h-auto">
      ...
      <div className="flex-shrink-0 bg-white border-t border-gray-200 px-4 py-4 sm:px-6">
        <div className="flex flex-col space-y-3 sm:flex-row sm:justify-end sm:space-y-0 sm:space-x-3">
          <button
            onClick={onConfirm}
            className="w-full sm:w-auto px-6 py-2.5 text-sm font-medium text-white bg-digitara-primary border border-transparent rounded-lg hover:bg-digitara-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-digitara-primary transition-colors"
          >
            Process Document
          </button>
          <button
            onClick={onCancel}
            className="w-full sm:w-auto px-6 py-2.5 text-sm font-medium text-digitara-neutral bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-digitara-primary transition-colors"
          >
